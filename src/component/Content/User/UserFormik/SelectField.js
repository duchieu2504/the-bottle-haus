...
function SelectField(props) {
    ...
    return (
        <div className={clsx(styles.form_group)}>
            { label && <label htmlFor="province" className={clsx(styles.form_label)}>{label}</label> }
            <div className={clsx(styles.form_select)}>
                ...
                >
                    ...
                    {
                        dataCity.length === 0 ? (<div> Chưa có dữ liệu </div>) :
                        dataCity.map(i => {
                            return (
                                <option 
                                    key={i.code}
                ...
                >
                    ...
                    {
                        dataDistrict.length === 0 ? (<option> Chưa có dữ liệu </option>) :
                        dataDistrict.map(i => {
                            return (
                                <option
                                    key={i.code}
                ...
                <select 
                    ...
                    {
                        dataWards.length === 0 ? (<option>Chưa có dữ liệu</option>) :
                        dataWards.map(i => {
                            return (
