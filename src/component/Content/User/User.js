    ...
    return (
        <form className={clsx(styles.form, { [styles.active]: activeSubmit })}>
            ...
            <div className={clsx(styles.form_group)}>
                <label for="fullname" className={clsx(styles.form_label)}>
                    Tên khách hàng
                </label>
                <input
                    id="fullname"
            ...
            <div className={clsx(styles.form_group)}>
                <label for="email" className={clsx(styles.form_label)}>
            ...
            <div className={clsx(styles.form_group)}>
                <label for="province" className={clsx(styles.form_label)}>
                    Địa chỉ
                </label>
            ...
            <div className={clsx(styles.form_group)}>
                ...
                <input
                    ...
                    type="text"
                    placeholder="Đường Quốc lộ 1, cạnh trạm cứu hỏa"
                    className={clsx(styles.form_control)}
                />
                <span className={clsx(styles.form_message)}></span>
            </div>

            <button className={clsx(styles.form_submit)} onClick={handleSubmit}>
                Tiếp tục
            </button>
        </form>
    );
