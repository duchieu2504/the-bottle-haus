// tạo mang chứa các số bất kì để render ả sản phâm bất kỳ
...
// tìm kiếm thẻ cha, hiện tượng sủi bỏi
...
// chuyển đôi chữ vd khuôn sắt => khuon_sat
export const removeVN = (str) => {
    if (str) {
...
// chuyển dổi số 1200000 => 1.200.000
